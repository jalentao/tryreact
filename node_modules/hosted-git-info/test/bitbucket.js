...
test('fromUrl(bitbucket url)', function (t) {
  function verify (host, label, branch) {
    ...
    t.is(hostinfo.browse(), 'https://bitbucket.org/111/222' + (branch ? '/lib/' + branch : ''), label + ' -> browse')
    t.is(hostinfo.docs(), 'https://bitbucket.org/111/222' + (branch ? '/lib/' + branch : '') + '#readme', label + ' -> docs')
