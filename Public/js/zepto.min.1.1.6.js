/*! Zepto 1.1.6 (generated with Zepto Builder) - zepto event ajax form ie touch stack selector ios3 assets callbacks data detect deferred fx fx_methods gesture - zeptojs.com/license */
var Zepto = function () {
    function t(t) {
    ...
    var E, T, S, j, C, O, P = [], A = P.concat, N = P.filter, M = P.slice, k = window.document, D = {}, Z = {}, L = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, $ = /^\s*<(\w+|!)[^>]*>/, F = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, R = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, _ = /^(?:body|html)$/i, q = /([A-Z])/g, z = ["val", "css", "html", "text", "data", "width", "height", "offset"], I = ["after", "prepend", "before", "append"], W = k.createElement("table"), B = k.createElement("tr"), V = {
        ...
        th: B,
        "*": k.createElement("div")
    }, H = /complete|loaded|interactive/, U = /^[\w-]*$/, X = {}, Y = X.toString, G = {}, J = k.createElement("div"), K = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    return G.matches = function (t, e) {
        ...
        data: function (t, e) {
            var n = "data-" + t.replace(q, "-$1").toLowerCase(), i = 1 in arguments ? this.attr(n, e) : this.attr(n);
            return null !== i ? w(i) : E
        },
        val: function (t) {
            return 0 in arguments ? this.each(function (e) {
        ...
        toggleClass: function (t, e) {
            return t ? this.each(function (n) {
                var i = S(this), r = v(this, t, n, b(this));
        ...
        position: function () {
            if (this.length) {
                var t = this[0], e = this.offsetParent(), n = this.offset(), i = _.test(e[0].nodeName) ? {
                    top: 0,
                    left: 0
                } : e.offset();
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    j.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
        ...
        var b, w = u.accepts[d], x = {}, E = function (t, e) {
            x[t.toLowerCase()] = [t, e]
        }, T = /^([\w-]+:)\/\//.test(u.url) ? RegExp.$1 : window.location.protocol, C = u.xhr(), O = C.setRequestHeader;
    ...
    t.each(m, function (t, n) {
        ...
        if (r === e && (r = t.fx.speeds._default / 1e3), g === e && (g = 0), t.fx.off && (r = 0), "string" == typeof i)E[l] = i, E[f] = r + "s", E[p] = g + "s", E[h] = d || "linear", j = t.fx.animationEnd; else {
            w = [];
