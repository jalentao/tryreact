...
function reactComponentExpect(instance) {
  ...
  !ReactTestUtils.isCompositeComponent(instance) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'reactComponentExpect(...): instance must be a composite components') : invariant(false) : undefined;
...
assign(reactComponentExpectInternal.prototype, {
   ...
   * - A components created via React.createClass() - Has a single child
   *   subComponent - the return value from the .render() function. This
   *   function @subComponent expects that this._instance is components created
   *   with React.createClass().
   * - A primitive DOM components - which has many renderedChildren, each of
   *   which may have a name that is unique with respect to its siblings. This
   *   method will fail if this._instance is a primitive components.
   *
   ...
   * render the components (simply instantiating is not enough).
   */
  ...
  /**
   * The nth child of a DOMish components instance that is not falsy.
   */
  ...
  /**
   * A components that is created with React.createClass. Just duck typing
   * here.
   */
  ...
  /**
   * A terminal type of components representing some virtual dom node. Just duck
   * typing here.
   */
