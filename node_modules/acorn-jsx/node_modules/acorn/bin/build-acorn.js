...
function acornShimPrepare(file) {
  ...
  if (file == path.resolve(__dirname, "../lib/index.js")) {
    var sent = false
...
browserify({standalone: "acorn.loose"})
  ...
  .transform(babelify)
  .require("./lib/loose/index.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
...
browserify({standalone: "acorn.walk"})
  ...
  .transform(acornShimPrepare)
  .transform(babelify)
  .require("./lib/walk/index.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
  .pipe(acornShimComplete())
  .pipe(fs.createWriteStream("dist/walk.js"))

babel.transformFile("./lib/bin/acorn.js", function (err, result) {
