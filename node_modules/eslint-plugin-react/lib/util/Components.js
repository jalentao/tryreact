 ...
 * @param {Number} confidence Confidence in the components detection (0=banned, 1=maybe, 2=yes)
 */
...
/**
 * Find a components in the list using its node
 *
 * @param {ASTNode} node The AST node being searched.
 * @returns {Object} Component object, undefined if the components is not found
 */
...
/**
 * Update a components in the list
 *
 * @param {ASTNode} node The AST node being updated.
 * @param {Object} props Additional properties to add to the components.
 */
...
function componentRule(rule, context) {
  ...
  // Utilities for components detection
  var utils = {

    /**
     * Check if the node is a React ES5 components
     *
     * @param {ASTNode} node The AST node being checked.
     * @returns {Boolean} True if the node is a React ES5 components, false if not
     */
    ...
    /**
     * Check if the node is a React ES6 components
     *
     * @param {ASTNode} node The AST node being checked.
     * @returns {Boolean} True if the node is a React ES6 components, false if not
     */
    ...
    /**
     * Get the parent components node from the current scope
     *
     * @returns {ASTNode} components node, null if we are not in a components
     */
    ...
    /**
     * Get the parent ES5 components node from the current scope
     *
     * @returns {ASTNode} components node, null if we are not in a components
     */
    ...
    /**
     * Get the parent ES6 components node from the current scope
     *
     * @returns {ASTNode} components node, null if we are not in a components
     */
    ...
    /**
     * Get the parent stateless components node from the current scope
     *
     * @returns {ASTNode} components node, null if we are not in a components
     */
    ...
    /**
     * Get the related components from a node
     *
     * @param {ASTNode} node The AST node being checked (must be a MemberExpression).
     * @returns {ASTNode} components node, null if we cannot find the components
     */
    getRelatedComponent: function(node) {
      ...
      // Traverse the node properties to the components declaration
  ...
  // Update the provided rule instructions to add the components detection
