...
module.exports = Components.detect(function(context, components) {
  ...
  function comparePropsOrder(propertiesNames, propA, propB) {
    ...
    for (i = 0, j = refIndexesA.length; i < j; i++) {
      ...
      for (k = 0, l = refIndexesB.length; k < l; k++) {
        ...
        if (
          ...
          refIndexA === refIndexB ||
          // 1st property is placed before the 2nd one in reference and in current components
          refIndexA < refIndexB && classIndexA < classIndexB ||
          // 1st property is placed after the 2nd one in reference and in current components
          refIndexA > refIndexB && classIndexA > classIndexB
        ) {
          return {
            correct: true,
    ...
    // We did not find any correct match between reference and current components
    return {
      correct: false,
      indexA: refIndexA,
      indexB: refIndexB
