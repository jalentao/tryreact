...
module.exports = Components.detect(function(context, components, utils) {
  ...
  /**
   * Checks if the components must be validated
   * @param {Object} component The components to process
   * @returns {Boolean} True if the components must be validated, false if not.
   */
   ...
   * @param {Object} declaredPropTypes Description of propTypes declared in the current components
  ...
  /**
   * Creates the representation of the React propTypes for the components.
  ...
  /**
   * Creates the representation of the React props type annotation for the components.
   * The representation is used to verify nested used properties.
  ...
  /**
   * Reports undeclared proptypes for a given components
   * @param {Object} component The components to process
   */
