...
module.exports = Components.detect(function(context, components) {
  ...
  var MULTI_COMP_MESSAGE = 'Declare only one React components per file';

  /**
   * Checks if the components is ignored
   * @param {Object} component The components being checked.
   * @returns {Boolean} True if the components is ignored, false if not.
   */
